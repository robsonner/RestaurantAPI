...
namespace RestaurantAPI.Services
{
    public class RestaurantService : IRestaurantService
    {
        ...
        public RestaurantDto GetById(int id)
        {
            ...
            if (restuarant is null) throw new NotFoundException($"Restaurant with {id} not found");
        ...
        public void Delete(int id)
        {
            ...
            if(restaurant is null) throw new NotFoundException($"Restaurant with {id} not found");
